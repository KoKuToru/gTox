...
**/
#include "gToxBuilder.h"

gToxBuilder::gToxBuilder(const Glib::RefPtr<Gtk::Builder>& builder):
    m_builder(builder) {
}

const Glib::RefPtr<Gtk::Builder> gToxBuilder::operator->() {
    return m_builder;
}

GtkWidget* gToxBuilder::get_cwidget(const Glib::ustring& name)
{
